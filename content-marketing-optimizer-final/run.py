...
Pipeline Steps:
---------------
1. Generate content variations  (content_generator)
2. Trend optimization           (trend_based_optimizer)
3. Sentiment analysis           (sentiment_analyzer)
4. A/B Comparison (simple) OR Full posting  (ABCoach)
5. Log raw feedback + aggregates (tracker)
6. Push metrics to Google Sheets (metrics_tracker)
